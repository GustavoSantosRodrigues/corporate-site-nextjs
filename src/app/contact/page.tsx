    ...
    return (
        <>
            <section className="relative w-full h-[40vh] lg:h-screen overflow-hidden bg-black">
                ...
                <div className="relative z-10 h-full container mx-auto px-6 pt-20 flex flex-col items-center justify-center text-center">
                    <h1 className="text-greenPaths-100 font-black uppercase 3xl:text-9xl xl:text-8xl md:text-6xl text-4xl">
                        Contato
                    </h1>

                    <p className="mt-6 text-white font-poppins xl:text-3xl md:text-xl text-base max-w-4xl leading-relaxed">
                ...
                <div className="container mx-auto px-6 flex flex-col lg:flex-row items-start gap-16">
                    ...
                    <div className="w-full lg:w-6/12 bg-white p-8 md:p-12 rounded-3xl shadow-xl">
                        <form className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="mt-4 px-10 py-4 rounded-full font-bold text-white bg-linear-to-r from-purple-600 to-purple-400 hover:opacity-90 transition">
                                Enviar
                            </button>
